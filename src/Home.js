...
const JSprojects = [
   {
    ...
    link: "https://gonzaloruiz99.github.io/JS-projects-links/3dPortfolio/",
  },
   {
    id: "JSproject_countDown",
    name:"Countdown",
    img:require("./JS_images/countDown_img.png"),
    link: "https://gonzaloruiz99.github.io/JS-projects-links/Countdown/",
  },
   {
    id: "JSproject_eCommerce",
    name:"E-commerce",
    img:require("./JS_images/eCommerce_img.png"),
    link: "https://gonzaloruiz99.github.io/JS-projects-links/Ecommerce/",
  },
   {
    id: "JSproject_fixedBackground",
    name:"Fixed background",
    img:require("./JS_images/fixedBackground_img.png"),
    link: "https://gonzaloruiz99.github.io/JS-projects-links/FixedBackground/",
  },
   {
    id: "JSproject_pricingTables",
    name:"Pricing tables",
    img:require("./JS_images/pricingTables_img.png"),
    link: "https://gonzaloruiz99.github.io/JS-projects-links/PricingTables/",
  },
   {
    id: "JSproject_roomHomepage",
    name:"Room homepage",
    img:require("./JS_images/roomHomepage_img.png"),
    link: "https://gonzaloruiz99.github.io/JS-projects-links/RoomHomepage/",
  },
]
...
const socials = [
  ...
  },
   {
    ...
    link: "https://www.linkedin.com/in/gonzalo-ruiz-p/",
  },
   {
    id: "webpage_icon",
    name:"Webpage",
    img:require("./home_images/website_icon.png"),
    link: "https://gonzaloruizp.work/",
  },
]
  ...
  return (
    <>
      <nav>
        ...
        <li className="links">
          <ul className="link"><a rel='noreferrer' href="https://gonzaloruizp.work/"  target='_blank'>UX portfolio</a></ul>
          <ul className="link"><a rel='noreferrer' href="https://www.linkedin.com/in/gonzalo-ruiz-p/"  target='_blank'>LinkedIn</a></ul>          
          <ul className="link"><a rel='noreferrer' href="https://github.com/gonzaloruiz99/portfolio2023" target='_blank'>GitHub</a></ul>          
        </li>
      </nav>
